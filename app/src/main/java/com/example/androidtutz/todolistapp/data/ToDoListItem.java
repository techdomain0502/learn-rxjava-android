...
public class ToDoListItem {
    ...
    public String toString() {
        return "ToDoListItem{" +
                ...
                ", toDoListItemBackgroundColor='" + toDoListItemBackgroundColor + '\'' +
                ", toDoListItemMoreInfo='" + toDoListItemMoreInfo + '\'' +
                ", toDoListItemCreatedDate='" + toDoListItemCreatedDate + '\'' +
                ", toDoListItemLatUpdatedDate='" + toDoListItemLatUpdatedDate + '\'' +
                ", toDoListItemPlanedAchievDate='" + toDoListItemPlanedAchievDate + '\'' +
                ", toDoListItemAchievedDate='" + toDoListItemAchievedDate + '\'' +
